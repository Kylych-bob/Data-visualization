...
Загрузка данных землетрясений
    загрузка данных о землетрясениях за месяц
    карта с указанием балла
    отражение глобальных распределений землетрясений
Построение карты мира
Добавление подсказки
    появдение подсказки при наведении мши на маркер
Пожары за последние 7 дней
------------------------------------------------------------
